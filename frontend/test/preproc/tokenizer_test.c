...
TEST(simple) {
    ...
    const Token expected[] = {
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 0x123213), 11, 9),
        create(TOKEN_ADD, StrBuf_null(), 11, 18),
        create_tok_val(Value_create_sint(VALUE_INT, 132), 11, 20),
        create(TOKEN_LSHIFT, StrBuf_null(), 11, 24),
        create_tok_val(Value_create_sint(VALUE_INT, 32), 11, 27),
        create(TOKEN_RSHIFT, StrBuf_null(), 11, 30),
        create_tok_val(Value_create_sint(VALUE_INT, 0x123), 11, 33),
        create(TOKEN_SUB, StrBuf_null(), 11, 39),
        create_tok_val(Value_create_sint(VALUE_INT, 0123), 11, 41),
        create(TOKEN_DIV, StrBuf_null(), 11, 46),
        create_tok_val(Value_create_sint(VALUE_INT, 12), 11, 48),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 1), 13, 9),
        create(TOKEN_QMARK, StrBuf_null(), 13, 11),
        create_tok_val(Value_create_sint(VALUE_INT, 100), 13, 13),
        create(TOKEN_COLON, StrBuf_null(), 13, 17),
        create_tok_val(Value_create_sint(VALUE_INT, 1000), 13, 19),
...
TEST(file) {
    ...
    const Token expected[] = {
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 16), 5, 14),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 4), 9, 19),
        create(TOKEN_COMMA, StrBuf_null(), 9, 20),
        create(TOKEN_COLON, StrBuf_null(), 9, 22),
        create_tok_val(Value_create_sint(VALUE_INT, 4), 9, 24),
        ...
        create_tok_val(Value_create_sint(VALUE_LINT, 1000l), 33, 21),
        create(TOKEN_MOD, StrBuf_null(), 33, 27),
        create_tok_val(Value_create_sint(VALUE_INT, 5), 33, 29),
        ...
        create_tok_val(Value_create_sint(VALUE_LINT, 30l), 37, 21),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 0), 46, 19),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 01000), 47, 19),
        create(TOKEN_LSHIFT, StrBuf_null(), 47, 25),
        create_tok_val(Value_create_sint(VALUE_INT, 10), 47, 28),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 0x1000), 55, 22),
        create(TOKEN_ADD, StrBuf_null(), 55, 29),
        create_tok_val(Value_create_sint(VALUE_INT, 033242), 55, 31),
        ...
        create_tok_val(Value_create_float(VALUE_DOUBLE, 1e-10), 66, 16),
        create(TOKEN_SUB, StrBuf_null(), 66, 22),
        create_tok_val(Value_create_float(VALUE_DOUBLE, 0xabecp10), 66, 24),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, '\n'), 70, 14),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 50000), 74, 20),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 0), 75, 24),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 0), 76, 18),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 0), 76, 49),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 5), 77, 28),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 4), 78, 28),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 0), 81, 13),
        ...
        create_tok_val(Value_create_uint(VALUE_UINT, 0xdeadbeef), 82, 18),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 40), 84, 18),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 1000), 86, 25),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 4), 96, 23),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 5), 97, 23),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 0x2341), 98, 19),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 1), 99, 17),
        create(TOKEN_RINDEX, StrBuf_null(), 99, 18),
        create(TOKEN_OR_ASSIGN, StrBuf_null(), 99, 20),
        create_tok_val(Value_create_sint(VALUE_INT, 1), 99, 23),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 0), 100, 13),
        create(TOKEN_RINDEX, StrBuf_null(), 100, 14),
        create(TOKEN_XOR_ASSIGN, StrBuf_null(), 100, 16),
        create_tok_val(Value_create_sint(VALUE_INT, 10423), 100, 19),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 1), 101, 14),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 1), 103, 12),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 0), 107, 17),
        create(TOKEN_RINDEX, StrBuf_null(), 107, 18),
        create(TOKEN_EQ, StrBuf_null(), 107, 20),
        create_tok_val(Value_create_sint(VALUE_INT, 37), 107, 23),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 1), 107, 40),
        create(TOKEN_RINDEX, StrBuf_null(), 107, 41),
        create(TOKEN_EQ, StrBuf_null(), 107, 43),
        create_tok_val(Value_create_sint(VALUE_INT, 37), 107, 46),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 123123), 107, 64),
        create(TOKEN_RSHIFT, StrBuf_null(), 107, 71),
        create_tok_val(Value_create_sint(VALUE_INT, 4), 107, 74),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 0), 114, 30),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 1), 116, 20),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, '\\'), 118, 14),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, '\''), 118, 24),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, '"'), 118, 34),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, '\0'), 118, 43),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 's'), 119, 13),
...
TEST(preproc_if) {
    ...
    const Token expected[] = {
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 100), 9, 10),
        ...
        create(TOKEN_IDENTIFIER,
               STR_BUF_NON_HEAP("the_world_is_in_order"),
               29,
               5),
        create(TOKEN_ASSIGN, StrBuf_null(), 29, 27),
        create_tok_val(Value_create_sint(VALUE_INT, 60), 29, 29),
        create(TOKEN_SEMICOLON, StrBuf_null(), 29, 31),
        ...
        create_tok_val(Value_create_sint(VALUE_INT, 23), 49, 18),
...
TEST(hex_literal_or_var) {
    {
        ...
        const Token expected[] = {
            ...
            create_tok_val(Value_create_sint(VALUE_INT, 10), 1, 6),
        };
        check_token_arr_str(code, expected, ARR_LEN(expected));
    }
    {
        ...
        const Token expected[] = {
            ...
            create_tok_val(Value_create_sint(VALUE_INT, 10), 1, 7),
        };
        check_token_arr_str(code, expected, ARR_LEN(expected));
    }
    {
...
TEST(dot_float_literal_or_op) {
    {
        ...
        const Token expected[] = {
            ...
            create_tok_val(Value_create_float(VALUE_DOUBLE, .001), 1, 9),
        };
        check_token_arr_str(code, expected, ARR_LEN(expected));
    }
}
