...
static void check_primary_expr_int_constant(enum constant_kind type,
                                            const char* spell,
...
static void check_primary_expr_float_constant(enum constant_kind type,
                                              const char* spell,
