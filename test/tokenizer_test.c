...
static void simple_test() {
    ...
    struct token expected[] = {
        ...
        create(I_CONSTANT, "0x123213", 11, 9),
        create(ADD, NULL, 11, 18),
        create(I_CONSTANT, "132", 11, 20),
        create(LEFT_OP, NULL, 11, 24),
        create(I_CONSTANT, "32", 11, 27),
        create(RIGHT_OP, NULL, 11, 30),
        create(I_CONSTANT, "0x123", 11, 33),
        create(SUB, NULL, 11, 39),
        create(I_CONSTANT, "0123", 11, 41),
        create(DIV, NULL, 11, 46),
        create(I_CONSTANT, "12", 11, 48),
        ...
        create(I_CONSTANT, "1", 13, 9),
        create(QMARK, NULL, 13, 11),
        create(I_CONSTANT, "100", 13, 13),
...
static void file_test() {
    ...
    struct token expected[] = {
        ...
        create(RBRACKET, NULL, 20, 27),
        create(SEMICOLON, NULL, 20, 28),
        ...
        create(I_CONSTANT, "1000l", 33, 21),
        create(MOD, NULL, 33, 27),
        create(I_CONSTANT, "5", 33, 29),
        ...
        create(I_CONSTANT, "01000", 47, 19),
        create(SUB, NULL, 47, 25),
        create(I_CONSTANT, "10", 47, 27),
        ...
        create(I_CONSTANT, "0x1000", 55, 22),
        ...
        create(RBRACKET, NULL, 65, 20),
        create(LBRACE, NULL, 65, 22),
        create(DOUBLE, NULL, 66, 5),
        create(IDENTIFIER, "d", 66, 12),
        create(ASSIGN, NULL, 66, 14),
        create(F_CONSTANT, "1e-10", 66, 16),
        create(SUB, NULL, 66, 22),
        create(F_CONSTANT, "1e10", 66, 24),
        create(SEMICOLON, NULL, 66, 28),
        ...
        create(ASTERISK, NULL, 77, 26),
        create(I_CONSTANT, "5", 77, 28),
        ...
        create(I_CONSTANT, "0x2341", 98, 19),
        ...
        create(I_CONSTANT, "0", 107, 17),
        create(RINDEX, NULL, 107, 18),
        create(EQ_OP, NULL, 107, 20),
        create(I_CONSTANT, "37", 107, 23),
        ...
        create(I_CONSTANT, "1", 107, 40),
        create(RINDEX, NULL, 107, 41),
        create(EQ_OP, NULL, 107, 43),
        create(I_CONSTANT, "37", 107, 46),
        create(QMARK, NULL, 107, 49),
        create(IDENTIFIER, "type_size", 107, 51),
        create(COLON, NULL, 107, 61),
        create(SUB, NULL, 107, 63),
        create(I_CONSTANT, "123123", 107, 64),
        create(RBRACKET, NULL, 107, 70),
        create(RBRACKET, NULL, 107, 71),
        create(SEMICOLON, NULL, 107, 72),
        ...
        create(F_CONSTANT, "1.0", 115, 39),
        create(COMMA, NULL, 115, 42),
        create(FLOAT, NULL, 115, 44),
        create(COLON, NULL, 115, 49),
        create(I_CONSTANT, "10", 115, 51),
        create(COMMA, NULL, 115, 53),
        create(DOUBLE, NULL, 115, 55),
        create(COLON, NULL, 115, 61),
        create(F_CONSTANT, "12.0", 115, 63),
        create(RBRACKET, NULL, 115, 67),
        create(SEMICOLON, NULL, 115, 68),
        create(STATIC_ASSERT, NULL, 116, 5),
        create(LBRACKET, NULL, 116, 19),
        create(I_CONSTANT, "1", 116, 20),
