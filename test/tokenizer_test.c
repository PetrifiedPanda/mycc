...
static void file_test() {
    ...
    Token expected[] = {
        ...
        create(CONSTANT, "1e-10", 66, 16),
        create(SUB, NULL, 66, 22),
        create(CONSTANT, "1e10", 66, 24),
        ...
        create(INT, NULL, 72, 5),
        create(IDENTIFIER, "true_bool", 72, 9),
        create(ASSIGN, NULL, 72, 19),
        create(NOT, NULL, 72, 21),
        create(LBRACKET, NULL, 72, 22),
        create(IDENTIFIER, "c", 72, 23),
        create(NE_OP, NULL, 72, 25),
        create(IDENTIFIER, "c", 72, 28),
        create(RBRACKET, NULL, 72, 29),
        create(AND_OP, NULL, 72, 31),
        create(LBRACKET, NULL, 72, 34),
        create(IDENTIFIER, "c", 72, 35),
        create(LE_OP, NULL, 72, 37),
        create(IDENTIFIER, "size", 72, 40),
        create(OR_OP, NULL, 72, 45),
        create(IDENTIFIER, "c", 72, 48),
        create(GE_OP, NULL, 72, 50),
        create(IDENTIFIER, "size", 72, 53),
        create(OR_OP, NULL, 72, 58),
        create(IDENTIFIER, "c", 72, 61),
        create(LT, NULL, 72, 63),
        create(IDENTIFIER, "size", 72, 65),
        create(OR_OP, NULL, 72, 70),
        create(IDENTIFIER, "c", 72, 73),
        create(GT, NULL, 72, 75),
        create(IDENTIFIER, "size", 72, 77),
        create(OR_OP, NULL, 72, 82),
        create(IDENTIFIER, "c", 72, 85),
        create(EQ_OP, NULL, 72, 87),
        create(IDENTIFIER, "size", 72, 90),
        create(OR_OP, NULL, 72, 95),
        create(IDENTIFIER, "c", 72, 98),
        create(NE_OP, NULL, 72, 100),
        create(IDENTIFIER, "size", 72, 103),
        create(RBRACKET, NULL, 72, 107),
        create(SEMICOLON, NULL, 72, 108),
        create(ENUM, NULL, 74, 5),
        create(LBRACE, NULL, 74, 10),
        create(IDENTIFIER, "LIMIT", 74, 12),
        create(ASSIGN, NULL, 74, 18),
        create(CONSTANT, "50000", 74, 20),
