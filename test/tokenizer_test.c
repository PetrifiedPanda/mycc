...
static void file_test() {
    ...
    Token expected[EXPECTED_SIZE] = {
        ...
        create(STATIC, NULL, 110, 1),
        create(VOID, NULL, 110, 8),
        create(IDENTIFIER, "variadic", 110, 13),
        create(LBRACKET, NULL, 110, 21),
        create(INT, NULL, 110, 22),
        create(IDENTIFIER, "m", 110, 26),
        create(COMMA, NULL, 110, 27),
