...
static void file_test() {
    ...
    Token expected[EXPECTED_SIZE] = {
        ...
        create(CONSTANT, "0", 107, 17),
        create(RINDEX, NULL, 107, 18),
        create(EQ_OP, NULL, 107, 20),
        create(CONSTANT, "37", 107, 23),
