...
TEST(file) {
    ...
    struct token expected[] = {
        ...
        create(I_CONSTANT, "4", 9, 19),
        create(COMMA, NULL, 9, 20),
        create(COLON, NULL, 9, 22),
        create(I_CONSTANT, "4", 9, 24),
        ...
        create(STATIC_ASSERT, NULL, 124, 1),
        create(LBRACKET, NULL, 124, 15),
        create(SIZEOF, NULL, 124, 16),
        create(LBRACKET, NULL, 124, 22),
        create(IDENTIFIER, "g_thread", 124, 23),
        create(RBRACKET, NULL, 124, 31),
        create(EQ_OP, NULL, 124, 33),
        create(SIZEOF, NULL, 124, 36),
        create(LBRACKET, NULL, 124, 42),
        create(INT, NULL, 124, 43),
        create(RBRACKET, NULL, 124, 46),
        create(COMMA, NULL, 124, 47),
